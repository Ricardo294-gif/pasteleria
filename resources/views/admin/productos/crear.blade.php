...
<div class="container-fluid">
    ...
    <div class="page-header">
        ...
        <p class="text-muted">Añade un nuevo producto al catálogo de la tienda.</p>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi bi-plus-circle me-2"></i>Información del Nuevo Producto
        </div>
        <div class="card-body">
            <form action="{{ route('admin.productos.guardar') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control @error('precio') is-invalid @enderror" 
                                   id="precio" name="precio" value="{{ old('precio') }}" step="0.01" required>
                            @error('precio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('ingredientes') is-invalid @enderror" 
                                      id="ingredientes" name="ingredientes" rows="3" required>{{ old('ingredientes') }}</textarea>
                            @error('ingredientes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('descripcion_larga') is-invalid @enderror" 
                              id="descripcion_larga" name="descripcion_larga" rows="4">{{ old('descripcion_larga') }}</textarea>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-lg me-2"></i>Crear Producto
                    </button>
